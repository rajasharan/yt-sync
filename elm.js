...
var _rajasharan$yt_sync$Types$Listen = function (a) {
	return {ctor: 'Listen', _0: a};
};
var _rajasharan$yt_sync$Types$UpdateSeekBar = function (a) {
...
var _rajasharan$yt_sync$Ports$pause = _elm_lang$core$Native_Platform.outgoingPort(
	'pause',
	function (v) {
		return null;
	});
var _rajasharan$yt_sync$Ports$seek = _elm_lang$core$Native_Platform.outgoingPort(
	'seek',
	function (v) {
		return v;
	});
var _rajasharan$yt_sync$Ports$total = _elm_lang$core$Native_Platform.outgoingPort(
	'total',
	function (v) {
		return null;
	});
var _rajasharan$yt_sync$Ports$width = _elm_lang$core$Native_Platform.outgoingPort(
	'width',
	function (v) {
		return null;
	});
	...
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'Connection':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					A2(_elm_lang$core$Debug$log, 'connected', model),
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'LoadVideo':
				return A2(
...
var _rajasharan$yt_sync$Decoders$decodeSocketMsg = F2(
	function (str, model) {
...
var _rajasharan$yt_sync$Encoders$encodeSocketMsg = function (msg) {
	var _p0 = msg.kind;
	switch (_p0.ctor) {
		case 'Connection':
			return A2(
				...
				_elm_lang$core$Json_Encode$object(
					_elm_lang$core$Native_List.fromArray(
						[
							...
							ctor: '_Tuple2',
							_0: 'kind',
							_1: _elm_lang$core$Json_Encode$string('Connection')
						},
							{
							ctor: '_Tuple2',
							_0: 'url',
				...
				_elm_lang$core$Json_Encode$object(
					_elm_lang$core$Native_List.fromArray(
						[
							...
							ctor: '_Tuple2',
							_0: 'kind',
							_1: _elm_lang$core$Json_Encode$string('LoadVideo')
						},
							{
							ctor: '_Tuple2',
							_0: 'url',
				...
				_elm_lang$core$Json_Encode$object(
					_elm_lang$core$Native_List.fromArray(
						[
							...
							ctor: '_Tuple2',
							_0: 'kind',
							_1: _elm_lang$core$Json_Encode$string('PlayPause')
						},
							{
							ctor: '_Tuple2',
							_0: 'url',
				...
				_elm_lang$core$Json_Encode$object(
					_elm_lang$core$Native_List.fromArray(
						[
							...
							ctor: '_Tuple2',
							_0: 'kind',
							_1: _elm_lang$core$Json_Encode$string('SeekPosition')
						},
							{
							ctor: '_Tuple2',
							_0: 'url',
...
var _rajasharan$yt_sync$Encoders$send = F2(
	function (kind, model) {
		return A2(
...
var _rajasharan$yt_sync$Views$footer = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('nav nav-item')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text(
				_elm_lang$core$Basics$toString(model.seek))
			]));
};
var _rajasharan$yt_sync$Views$ribbon = A2(
	_elm_lang$html$Html$a,
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html_Attributes$href('https://github.com/rajasharan/yt-sync')
		]),
	_elm_lang$core$Native_List.fromArray(
		[
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$html$Html_Attributes$src('https://s3.amazonaws.com/github/ribbons/forkme_right_gray_6d6d6d.png'),
					_elm_lang$html$Html_Attributes$alt('Fork me on GitHub')
				]),
			_elm_lang$core$Native_List.fromArray(
				[]))
		]));
var _rajasharan$yt_sync$Views$banner = A2(
	_elm_lang$html$Html$section,
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html_Attributes$class('hero is-primary is-bold')
		]),
	_elm_lang$core$Native_List.fromArray(
		[
			A2(
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('Youtube Sync & Watch togther')
								])),
							A2(
							_elm_lang$html$Html$p,
							_elm_lang$core$Native_List.fromArray(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('(broadcast via WebSockets)')
								]))
						]))
				]))
		]));
var _rajasharan$yt_sync$Views$playbar = function (model) {
	var total = A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Basics$toString(
			_elm_lang$core$Basics$round(model.total)),
		' sec');
	var curr = A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Basics$toString(
			_elm_lang$core$Basics$round(model.seek)),
		' sec / ');
	return A2(
		_elm_lang$html$Html$p,
		_elm_lang$core$Native_List.fromArray(
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Attributes$class('input is-expanded hint--bottom hint--bounce'),
						...
						_elm_lang$html$Html_Attributes$defaultValue('0'),
						_elm_lang$html$Html_Attributes$value(
						_elm_lang$core$Basics$toString(model.seek)),
						A2(
						_elm_lang$html$Html_Attributes$attribute,
						'aria-label',
						A2(_elm_lang$core$Basics_ops['++'], curr, total)),
						_elm_lang$html$Html_Events$onInput(_rajasharan$yt_sync$Types$SeekBar)
					]),
				_elm_lang$core$Native_List.fromArray(
					[]))
			]));
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Youtube sync')
					]))
			]));
};
...
var _rajasharan$yt_sync$Views$mainLayout = function (model) {
	var cards = A2(
		_elm_lang$core$List$map,
		function (vid) {
...
var _rajasharan$yt_sync$Views$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_rajasharan$yt_sync$Views$banner,
				_rajasharan$yt_sync$Views$ribbon,
				_rajasharan$yt_sync$Views$mainLayout(model)
			]));
};

var _rajasharan$yt_sync$Update$update = F2(
	function (msg, model) {
		var secs$ = function (res) {
			var _p0 = res;
			if (_p0.ctor === 'Ok') {
				return _p0._0;
			} else {
...
var _rajasharan$yt_sync$Main$init = function (hash) {
	var model = _rajasharan$yt_sync$Types$createModel;
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		_elm_lang$core$Native_Utils.update(
			model,
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _rajasharan$yt_sync$Main$main === 'undefined' ? null : _rajasharan$yt_sync$Main$main);

...
var _rajasharan$yt_sync$Types$CheckCursor = function (a) {
	return {ctor: 'CheckCursor', _0: a};
};
				...
				return A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							model.server,
							_rajasharan$yt_sync$Encoders$encodeSocketMsg(
								{kind: _rajasharan$yt_sync$Types$PlayPause, url: model.url, play: model.play, seek: model.cursorWidth}))
						]));
			case 'Error':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
...
var _rajasharan$yt_sync$Main$init = {
	ctor: '_Tuple2',
	_0: {url: '', err: '', server: 'ws://192.168.1.5:5000/', play: false, total: 0.0, width: 1000, cursorWidth: 0.0},
	_1: _elm_lang$core$Platform_Cmd$none
};
var _rajasharan$yt_sync$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _rajasharan$yt_sync$Main$init, update: _rajasharan$yt_sync$Main$update, subscriptions: _rajasharan$yt_sync$Main$subs, view: _rajasharan$yt_sync$Main$view})
};
